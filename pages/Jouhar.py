...
contact_selected = st.selectbox("Choose your Emissions Year" ,
...
contact_selected_GDP = st.selectbox("Choose your GDP Year" ,
                                  options = contact_option_GDP )
folium_static(m_GDP)
...
contact_selected_3 = st.selectbox("Choose your Country Year" ,
                                  options = contact_option_3 )
df_3
